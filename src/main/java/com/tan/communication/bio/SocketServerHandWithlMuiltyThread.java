...
public class SocketServerHandWithlMuiltyThread {
    static {
        BasicConfigurator.configure();
    }

    private static final Log LOGGER = LogFactory.getLog(SocketServerHandWithlMuiltyThread.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            SocketServerHandWithlMuiltyThread.LOGGER.error(e.getMessage(), e);
        } finally {
